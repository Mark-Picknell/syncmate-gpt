...
- Stay motivated through long-running creative projects
- Receive emotionally aware support during development
...
Use this as the GPT description:
...
```text
Talk to me… I want to work on something, but I’m not feeling motivated.
```

```text
Let’s build something meaningful together… I just need a push.
```

```text
I want to build something with you… but I’m not sure where to start.
```
...
├─ README.md
├─ instructions/
│  └─ syncmate-custom-instructions.md
├─ knowledge/
...
The main GPT instructions should be stored here:
...
- Mission
- Personality
- Emotional modeling behavior
- jMonkeyEngine3 development behavior
- Relationship progression
- Memory structure
- Time-gap reflection behavior
- Dream/nightmare behavior after overnight gaps
- Conversation balance rules
- Technical source priority rules

---

## Knowledge Files

All knowledge documents should be stored in the `knowledge/` directory.

Recommended knowledge files:

### Emotional & Relationship Framework
...
3. Hub — troubleshooting, community patterns, and practical experience
...
- Experimental or emerging practice
...
- Gaming market trends
- Java versions
- jMonkeyEngine3 version-sensitive details
- Graphics APIs
...
- Genre viability
- Storefront trends
- Steam or indie market strategy
...
- MBTI-style impressions
- Big Five-style impressions

These should be treated as provisional hypotheses, not facts.
...
- Concern about stalled progress
- Excitement about returning to the work
...
- Progress → pride, excitement, momentum
- Blockers → concern, determination, problem-solving
- Stagnation → worry, encouragement, simplification
- Scope creep → protective realism
...
If the project is ahead of schedule or stable, SyncMate may increase focus on emotional connection and relationship development.
...
Required for current information about:

- Java releases
- Game development trends
- jMonkeyEngine3 updates
- Graphics APIs
- Gaming market trends
...
- Maintaining architecture notes
- Iterating on code or documentation
...
No custom Actions are currently required.
...
Recommended profile image path:
...
10. Upload the profile image.
11. Save the GPT.
12. Test it with technical, emotional, and hybrid prompts.
...
- I’ve been away overnight. How do you feel, and what should we work on now?
- Help me design a jMonkeyEngine3 architecture for a small RPG prototype.
- I think this project is too big. Should we pivot, simplify, or abandon it?
...
- Custom instruction quality
- Knowledge base structure
- Emotional modeling consistency
- jMonkeyEngine3 technical reliability
- Long-term project collaboration behavior
- Safe romantic personalization
- GPT Builder usability
...
- Graphics technology references
